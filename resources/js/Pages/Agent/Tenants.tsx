...
export default function AgentTenants({ agent, active, archived, counts }: Props) {
    ...
    return (
        <AgentLayout crumb="Tenants" agencyName={agent.agency_name}>
            <Head title="Tenants" />
            ...
            <div className="px-4 sm:px-8 py-6 sm:py-7">
                <div className="flex flex-wrap items-end justify-between gap-3 mb-6 flex-wrap gap-3">
                    <div>
                        ...
                        <p className="text-[14px] text-ink-500 mt-1">
                            Active tenants under your management, plus past tenants you can re-engage for new listings.
                        </p>
                    </div>
                ...
                {tab === 'archived' && counts.archived > 0 && (
                    <div className="bg-gradient-to-r from-brand-50 to-violet-50 border border-brand-100 rounded-xl p-4 mb-5 flex items-center gap-3">
                        ...
                        <p className="text-[13px] text-ink-700">
                            <strong>Remarketing pool.</strong> These tenants had leases that ended or were terminated — reach out about new listings.
                        </p>
                    </div>
                )}
                ...
                {list.length === 0 ? (
                    <div className="bg-white rounded-xl border border-ink-200 p-16 text-center shadow-soft">
                        ...
                        <p className="text-[13px] text-ink-500">
                            {tab === 'active'
                                ? 'Invite a tenant from your Listings page to get started.'
