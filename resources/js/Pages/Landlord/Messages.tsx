...
export default function LandlordMessages({ landlord, conversations, active, messages }: Props) {
    ...
    function send() {
        ...
        setSending(true);
        router.post(`/landlord/messages/${active.id}`, { body }, {
            preserveScroll: true,
            onSuccess: () => setBody(''),
    ...
    return (
        <LandlordLayout crumb="Messages" section="People" unreadMessages={totalUnread}>
            <Head title="Messages" />
            ...
            <div className="flex h-[calc(100vh-64px)]">
                ...
                <div className="w-72 shrink-0 bg-white border-r border-ink-200 flex flex-col">
                    <div className="p-4 border-b border-ink-200">
                        ...
                        <p className="text-[11px] text-ink-500">Talk to your tenants</p>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {conversations.length === 0 ? (
                            ...
                            conversations.map((conv) => (
                                <button
                                    key={conv.id}
                                    onClick={() => router.get('/landlord/messages', { conversation_id: conv.id }, { preserveState: true })}
                ...
                {active ? (
                    <div className="flex-1 flex flex-col min-w-0">
                        ...
                        <div className="border-t border-ink-200 bg-white p-4">
                            ...
                            <p className="text-[10px] text-ink-400 mt-2">Conversations are retained per your account settings (POPIA-compliant).</p>
                        </div>
                    </div>
                ) : (
